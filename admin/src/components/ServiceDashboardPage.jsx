...
import { serviceDashboardStyles as sd } from '../assets/dummyStyles.js'

import { BadgeIndianRupee, Calendar, CheckCircle, ClipboardList, Dice1, Search, XCircle } from 'lucide-react'
// normilize the backend data that is coming from the database
            ...
            <div className={sd.innerContainer}>
                ...
                <div className={sd.header.container}>
                    <div>
                        ...
                        <p className={sd.header.subtitle}>Overview of service, appointments, and earnings</p>
                    </div>
                    ...
                    <div className={sd.refresh.container}>
                        ...
                        <button onClick={() => {
                            ...
                            title={Array.isArray(servicesProp) ? "Services provided by parent component" : "Refresh services"}>
                            Refresh
                        </button>
                    </div>
                </div>
                ...
                <div className={sd.search.container}>
                    <div className={sd.search.inputContainer}>
                        ...
                        {searchQuery && (
                            <XCircle size={16} className="text-red-700 cursor-pointer" onClick={() => setSearchQuery("")} />
                        )}
                    </div>
                </div>
                ...
                <div className={sd.table.body}>
                    {loading ? (
                        <div className={sd.states.loading}>Loading Services...</div>
                    ) : error ? (
                        <div className={sd.states.error}>Error: {error}</div>
                    ) : visibleServices.length === 0 ? (
                        <div className={sd.states.empty}>No services Found</div>
                    ) : (
                                    ...
                                    <div className={sd.table.row}>
                                        ...
                                        <div className={sd.table.tabletView}>
                                            <div className="flex items-center gap-3">
                                                <div
                                                    className={sd.table.tabletImage}
                                                >
                                                    <img
                                                        src={s.image}
                                                        alt={s.name}
                                                ...
                                                <div
                                                    className={
                                                        sd.table.tabletTextContainer
                                                    }
                                                >
                                                    <div
                                                        className={
                                                            sd.table.tabletServiceName
                                                        }
                                                    >
                                                        {s.name}
                                                    </div>
                                                    <div
                                                        className={sd.table.tabletPrice}
                                                    >
                                            ...
                                            <div className={sd.table.tabletCell}>
                                                {s.totalAppointments}
                                            </div>
                                            <div
                                                className={`${sd.table.tabletCell} text-emerald-700`}
                                            >
                                                {s.completed}
                                            </div>
                                            <div
                                                className={`${sd.table.tabletCell} text-red-500`}
                                            >
                                                {s.canceled}
                                            </div>
                                            <div
                                                className={`${sd.table.tabletCell} text-right`}
                                            >
                                        ...
                                        <div className={sd.table.desktopView}>
                                            <div className="col-span-5 flex items-center gap-4">
                                                ...
                                                <h3 className={sd.table.desktopServiceName}>{s.name}</h3>
                                            </div>
                                            ...
                                            <div className={`${sd.table.desktopCenterCell(2,)} text-right`}>
                                                {formatCurrency(earning)}
                                            </div>
                                        </div>
                                        {/* for mobile view */}
...
function StatCard({ icon, label, value }) {
    return (
        <div className={sd.statCard.container}>
            <div className={sd.statCard.iconContainer}>{icon}</div>
            <div>
