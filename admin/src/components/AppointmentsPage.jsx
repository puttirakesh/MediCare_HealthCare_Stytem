...
import { pageStyles as ps, statusClasses as sc, keyframesStyles as ks } from '../assets/dummyStyles';
...
const AppointmentsPage = () => {
    ...
    // fetch list of appointments from the server 
    useEffect(() => {
        async function load() {
            setLoading(true);
            setError(null);
            ...
            <div className={ps.maxWidthContainer}>
                <header className={ps.headerContainer}>
                    <div className={ps.headerTitleSection}>
                        ...
                        <p className={ps.headerSubtitle}>Manage and search for upcoming appointments</p>
                    </div>
                    ...
                    <div className={ps.headerControlsSection}>
                        <div className='flex flex-col md:flex-col sm:flex-row items-center gap-3 w-full sm:w-auto'>
                            <div className={ps.searchContainer}>
                                ...
                                <input
                                    className={ps.searchInput} placeholder='Search doctors, speciality or mobile'
                            ...
                            <div className={ps.filterContainer}>
                                <div className={ps.dateFilter}>
                                    ...
                                    <input type="date" className={ps.dateInput} value={filterDate}
                                        onChange={(e) => setFilterDate(e.target.value)} />
                                </div>

                                <select className={ps.selectFilter} value={filterSpeciality}
                ...
                {loading ? (
                    ...
                    <div className={ps.noResultsContainer}>No appointments found</div>
                ) : (
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between gap-3 flex-wrap">
                                        ...
                                        <div
                                            className={`${ps.statusBadge} ${sc(a.status)}`}
                                        >
                ...
                {sortedFiltered.length > 8 && (
                    <div className='flex justify-center mt-4'>
                        <button onClick={() => setShowAll(true)} className={ps.showMoreButton}>
