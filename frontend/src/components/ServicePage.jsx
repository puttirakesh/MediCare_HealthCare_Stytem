...
import { servicePageStyles as s , serviceCardStyles} from '../assets/dummyStyles.js'
    ...
    <div className={s.pageContainer}>
        <div className={s.maxWidthContainer}>
            <header className={s.header}>
                ...
                <p className={s.subtitle}>Safe, Accurate & reliable diagnostic services for you.</p>
            </header>

            {error && (
                <div className={s.errorContainer}>
                    <div className={s.errorText}>{error}</div>
                    <button onClick={loadServices} className={s.retryButton}>
                        Retry
                    </button>
                </div>
            )}
